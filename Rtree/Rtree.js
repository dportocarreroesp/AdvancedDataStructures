...
class Rtree{
    ...
    splitNode(NodeTree,i,first,last){
        if(i == 0){
            ...
            mbr = null;
           mbr = new Rectangle(middle_x,middle_y,middle_x-min_x,middle_y-min_y);
            ...
            var max_y = NodeTree.points[last-1].y;//para x posibles casos
    ...
    split(NodeTree){
        ...
        while (i<k) {
            ...
            for(var j = NodeTree.minimun ; j < m-NodeTree.minimun; j++){
    ...
    choose_subtree(NodeTree,point){
        ...
        for(i = 0; i < NodeTree.nro_data ; i++){
            ...
            if(NodeTree.points[i].contains(point)){
                ...
                if(into_x == true && into_y == false){
                    ...
                    if(range >= 0){
                        ...
                        console.log("menor igual a cero"); 
                        var incre_middle = (point.y + (y+h))/2;
                        aux_x = x;
                        aux_y = incre_middle;
                        aux_w = w;
            ...
            console.log(veri_perimeter ,"< = ",min_perimeter );
    ...
    traverse(root){ 
        ...
        { 
            if (root.leaf === false){
                ...
                noFill();
                rectMode(CENTER);
                rect(root.points[i].x,400-root.points[i].y,2*root.points[i].w,2*root.points[i].h);
